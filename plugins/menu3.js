...
`.trim()
 ...
 await conn.send2ButtonImg(m.chat, text.trim(), "./src/logo.jpg", "Jangan spam\nJika tidak ingin bot delay\n\n© PSYCO BOT", 'Menu', '.bwha', 'Saya mau liat list sewa bot', '.jsb', { quoted: fgif, sendEphemeral: true, contextInfo: { mentionedJid: conn.parseMention(text), forwardingScore: 135, isForwarded: true }})
